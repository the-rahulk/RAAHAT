...
if(isset($_POST['addUser'])) {
    ...
    if($password == $confirmpassword) {
        ...
        if(mysqli_num_rows($checkemail_run)>0) {
            ...
            $user_query = "INSERT INTO admin (name,phone,email,role,password) VALUES ('$name','$phone','$email','$role','$password')";
...
if(isset($_POST['updateUser'])) {
    ...
    $query = "UPDATE admin SET name='$name', phone='$phone', email='$email', role='$role', password='$password' WHERE id = '$user_id' ";
